...
class DeviceScanScreen extends StatelessWidget {
  final BtController controller = Get.find();

  DeviceScanScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('ChatBlue')),
      body: Obx(
        () => Column(
          children: [
            Row(
              ...
              children: [
                ElevatedButton(
                  ...
                  child: Text(
                    controller.isServerModeActive.value ? 'Stop Discoverable' : 'Make Discoverable',
                  ),
                ),
                ElevatedButton(
                  ...
                  child: Text(controller.isScanning.value ? 'Stop Scanning' : 'Scan for Devices'),
                ),
              ],
            ),
            Expanded(
